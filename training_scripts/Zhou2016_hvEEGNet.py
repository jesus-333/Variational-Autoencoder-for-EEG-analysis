"""
Train hvEEGNet with the dataset Zhou2016.
...
# Training
training_config = toml.load(path_traing_config)
training_config['train_iteration_per_subject'][str(subj)] += 1
training_config['name_training_run'] = 'S{}_{}_run_train_{}'.format(subj, id_machine, training_config['train_iteration_per_subject'][str(subj)])
...
#     training_config['name_training_run'] = ''
#     toml.dump(training_config, toml_file)
