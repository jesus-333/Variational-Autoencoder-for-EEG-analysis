...
def convert_parameters_into_single_matrix(parameters_for_distribution : list, list_mean_for_distribution : list, list_var_for_distribution : list) :
    parameters_matrix = []
    ...
    for i in range(len(distributions_list)) :
        ...
        parameters_matrix.append(list_mean_for_distribution[distribution])
        parameters_matrix.append(list_var_for_distribution[distribution])
