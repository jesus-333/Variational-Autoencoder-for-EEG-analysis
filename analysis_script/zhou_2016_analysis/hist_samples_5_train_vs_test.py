...
for i in range(len(subj_list)):
    ...
    train_dataset, _, test_dataset, _ = support.get_dataset_zhou2016_and_model(dataset_config, model_config, model_name = 'hvEEGNet_shallow')
    ...
    if plot_config['save_fig']:
        ...
        # Create pat
        path_save = 'Saved Results/zhou2016_analysis/hist_samples_train_vs_test/bins {}/'.format(plot_config['bins'])
