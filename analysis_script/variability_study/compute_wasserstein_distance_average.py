...
path_save_session_1 = 'Saved Results/wasserstein/{}/distance_train_session_1_epoch_{}_average.npy'.format(path_string, epoch)
path_save_session_2 = 'Saved Results/wasserstein/{}/distance_train_session_2_epoch_{}_average.npy'.format(path_string, epoch)
