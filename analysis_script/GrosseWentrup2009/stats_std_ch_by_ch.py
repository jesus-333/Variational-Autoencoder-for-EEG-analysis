...
path_dataset_config = 'training_scripts/config/GrossWentrup2009/dataset.toml'
...
for i in range(len(subj_list)) :
    ...
    train_data, labels_train, ch_list = download.get_GrosseWentrup2009(dataset_config, 'train')
    test_data, test_labels, ch_list = download.get_GrosseWentrup2009(dataset_config, 'test')
    ...
    if plot_config['save_fig']:
        path_save = "Saved Results/GrossWentrup2009/stats_ch/std/"
